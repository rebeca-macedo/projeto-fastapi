...
@app.get('/cursos', description='Restorna todos os cursos ou uma lista vazia.', summary='Retorna todos os cursos.', response_model=List[Curso], response_description='Cursos encontrados com sucesso.')
